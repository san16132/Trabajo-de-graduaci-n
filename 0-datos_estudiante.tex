...
% -------------------------------------------------------------------------------
% Nombre completo
\def \nombreestudiante {Elías Josué Sánchez Perdomo}
% Carné
\def \uvgcarne {16132}
% Facultad
...
% -------------------------------------------------------------------------------
% Título completo
\def \titulotesis {Diseño e implementación de cuatro tableros de control industrial enfocado en el módulo analógico con fines didácticos para uso en la Universidad del Valle de Guatemala}
% Año de entrega
\def \anoentrega {2020}
% Asesor
